...
function buildAboutView(container: any): void {
  ...
  const subtitle = Text("A native iOS JSON viewer")
  ...
  const tech2 = Text("No Electron, no browser, no Node.js runtime")
  textSetFontSize(tech2, 13)
  textSetColor(tech2, 0.4, 0.4, 0.4, 1.0)
  widgetAddChild(container, tech2)
...
// --- Keyboard shortcuts (for iPad with external keyboard) ---
